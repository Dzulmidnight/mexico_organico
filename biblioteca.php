...
$row_biblioteca = mysql_query("SELECT * FROM biblioteca WHERE tipo_documento = 'BIBLIOTECA' ORDER BY fecha_actualizada DESC, fecha_registro DESC", $conectar);
                    ...
                    <div class="row margin-vert-30">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="headline">
                                        <h2 class="text-center">Biblioteca México Orgánico</h2>
                                    </div>
                                    <?php 
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            if($numero_documentos == 0){
                                                ...
                                                ?>
                                                <tr>
                                                    <td>ID: <?php echo $documento['idbiblioteca']; ?><b style="color:#c0392b"><?php echo $documento['titulo']; ?></b></td>
                                                    ...
                                                    <td>
                                                        <?php 
                                                        if(!empty($documento['fecha_actualizada'])){
                                                            echo date('d/m/Y', $documento['fecha_actualizada']);
                                                        }else{
                                                            echo date('d/m/Y', $documento['fecha_registro']);
                                                        }
                                                        ?>      
                                                    </td>
                                                </tr>
